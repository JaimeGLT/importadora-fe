    ...
    >
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-xs text-[#7A7571] max-w-xs">No hay ventas de este usuario en el período seleccionado.</p>
        </div>
      ) : (
        <>
          {/* KPIs */}
          ...
          <div className="grid grid-cols-2 gap-2.5 mb-4">
            ...
            <div className="bg-white rounded-lg border border-[#E8E5E2] border-l-4 border-l-[#780e18] p-3">
              ...
              <p className="text-lg font-black text-[#780e18] tabular-nums">{fmtBs(usuario?.montoComision ?? 0)}</p>
            </div>
          </div>
